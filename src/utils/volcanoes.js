 ...
 * Koordinat, elevasi, dan radius bahaya = data referensi statis (akurat).
 * STATUS AKTIVITAS TIDAK DI-HARDCODE: statusLevel diisi 0 (belum diketahui)
 * lalu diperbarui REAL-TIME dari MAGMA ESDM via services/volcano.js (/api/volcanoes).
 */
...
export const VOLCANO_STATUS_LEVELS = {
  0: {
    ...
    description: 'Status aktivitas live dari MAGMA ESDM belum berhasil dimuat.',
    recommendation: 'Cek status resmi terkini di https://magma.esdm.go.id'
  },
  1: {
    level: 1,
    name: 'Normal',
...
export const INDONESIA_VOLCANOES = [
  // JAWA
  {
    ...
    elevation: 2968,
    type: 'Stratovolcano',
    statusLevel: 0, // diisi real-time dari MAGMA ESDM (default: belum diketahui)
    dangerRadiusKm: 5.0,
